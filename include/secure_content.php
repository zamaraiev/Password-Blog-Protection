	    ...
	    <div id="popupBackground">
		    <div id="passwordPopup">
                <form id="passwordForm" class="passwordForm">
                    ...
                    <label for="passwordInput" class="passwordForm__lable"><?php esc_html_e('Password:', 'blog-password-protection-bpp'); ?></label>
                    <input type="password" id="passwordInput" class="passwordForm__input" required>
                    <div class="passwordForm__form-group">
                        <button type="submit" class="passwordForm__button"><?php esc_html_e('Submit', 'blog-password-protection-bpp'); ?></button>
